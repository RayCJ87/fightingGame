...
//---------
    game.load.tilemap('map','/images/livel1.csv');
...
//-----------------------------
   ...
   // ground = game.add.sprite(game.world.width/2, game.world.height-24,'ground');
    //game.physics.p2.enable(tiles);  //enable physics so our player will not fall through ground but collide with it
  //  ground.body.static=true;    // ground should not move
    ...
    //setup our player
    player = game.add.sprite(0, 0, 'mario'); //create and position player
